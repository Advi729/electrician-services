  ...
  return (
    ...
    >
      <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
        ...
        <p className="mb-8 text-lg font-normal text-teal-900 lg:text-xl sm:px-16 xl:px-48">
        ...
        <div className="flex justify-center items-center">
          <div className="pl-3">
            ...
            <div className="relative">
              ...
              />
              <button
                className="text-white absolute right-2.5 bottom-2.5 bg-blue-500 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                onClick={() => {
